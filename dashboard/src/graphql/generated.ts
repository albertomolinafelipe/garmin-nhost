...
export type GeneratedAllPlanRequirementsQuery = { plan_requirements: Array<{ id: unknown, week: string, sport: string | null, metric: string, target: unknown }> };

export type GeneratedAllPlanWorkoutsQueryVariables = Exact<{ [key: string]: never; }>;


export type GeneratedAllPlanWorkoutsQuery = { plan_workouts: Array<{ id: unknown, plan_id: unknown, week: string, day_of_week: string, sport: string, title: string, description: string | null }> };
